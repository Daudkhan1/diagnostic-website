...
const ProjectSection = ({ data }) => {
  // Pehla tab active hoga dynamically
        ...
        {data?.tabData.map((tab) => (
          <div
            ...
            className={`container-fluide cs_tab ${
              tab.id === activeTab ? "active show" : "d-none"
            }`}
            id={tab.id}
          >
                  ...
                  <div className="cs_card cs_style_1">
                    <Link to="/" className="cs_card_thumbnail d-block">
                      <img
                        ...
                        onMouseEnter={(e) =>
                          (e.currentTarget.src = item.hoverImgUrl)
                        }
                        onMouseLeave={(e) =>
                          (e.currentTarget.src = item.imgUrl)
                        }
                      />
                    </Link>
