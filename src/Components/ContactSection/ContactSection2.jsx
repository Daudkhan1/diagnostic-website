        ...
        <div className="row cs_gap_y_40">
          <div className="col-lg-6">
            <div className="cs_section_heading cs_style_1">
              ...
              <h2 className="cs_section_title">We'd Love To Hear From You</h2>
            </div>
            ...
            <form className="cs_contact_form row cs_gap_y_30 home_form_area">
              ...
              style={{ 
                padding: '20px', 
                display: 'flex', 
                justifyContent: 'flex-end' // Pushes flex items (the button) to the right
              }}
              >
          ...
          <div className="col-lg-6">
            <div
              ...
              data-background="/assets/img/medical_solution_1.jpg"
            ></div>
          </div>
        </div>
      </div>
